// src/components/bachelors/StructureSection.tsx
'use client';
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {[
            { value: '60-90', label: t('structure.stats.totalPages') },
            { value: '7', label: t('structure.stats.sections') },
            { value: '15-30', label: t('structure.stats.sources') },
