// src/components/bachelors/CTASection.tsx
'use client';
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
            ...
            >
              <Link href="/register">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group px-8 py-4 bg-white text-blue-600 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-white/50 transition-all duration-300"
                >
          ...
          >
            {[
              { value: '60-90', label: t('cta.stats.pages') },
              { value: '199 zł', label: t('cta.stats.price') },
              { value: '60-90 min', label: t('cta.stats.time') },
