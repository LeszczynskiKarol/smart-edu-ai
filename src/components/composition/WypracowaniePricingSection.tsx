// src/components/composition/WypracowaniePricingSection.tsx
'use client';
...
const WypracowaniePricingSection: React.FC = () => {
  const { theme } = useTheme();
  const t = useTranslations('Wypracowanie.pricing');
...
export default WypracowaniePricingSection;
