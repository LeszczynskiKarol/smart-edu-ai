// src/components/rozprawka/HowItWorksSection.tsx
'use client';
...
const HowItWorksSection: React.FC = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      details: [
        t('howItWorks.steps.analysis.detail1'),
        t('howItWorks.steps.analysis.detail2'),
        t('howItWorks.steps.analysis.detail3'),
      ],
    },
    {
      icon: Cpu,
                  ...
                  {(() => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`w-32 h-32 rounded-3xl bg-gradient-to-br ${steps[activeStep].gradient} flex items-center justify-center shadow-2xl mb-8`}
                      >
