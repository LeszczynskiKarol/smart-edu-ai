// src/components/rozprawka/BenefitsSection.tsx
'use client';
...
const BenefitsSection: React.FC = () => {
  ...
  const benefits = [
    ...
    {
      icon: BookOpen,
      titleKey: 'benefits.arguments.title',
      descriptionKey: 'benefits.arguments.description',
      gradient: 'from-green-500 to-emerald-500',
      features: [
        t('benefits.arguments.feature1'),
        t('benefits.arguments.feature2'),
        t('benefits.arguments.feature3'),
      ],
    },
    {
      icon: Award,
