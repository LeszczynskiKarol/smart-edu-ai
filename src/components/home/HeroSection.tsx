...
const HeroSection: React.FC<HeroSectionProps> = ({ title, subtitle, cta }) => {
  ...
  const features = [
    {
      icon: BookOpen,
      text: t('features.topic.title'),
      description: t('features.topic.description'),
    },

    {
      icon: Brain,
      text: t('features.quality.title'),
      description: t('features.quality.description'),
    },
    {
      icon: Sparkles,
      text: t('features.multilingual.title'),
      description: t('features.multilingual.description'),
    },
    {
      icon: Clock,
      text: t('features.speed.title'),
