// src/components/masters/HeroSection.tsx
'use client';
      ...
      <div className="container mx-auto px-4 pt-32 pb-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <Link href="/register">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-2xl font-semibold text-lg shadow-2xl hover:shadow-purple-500/50 transition-all duration-300"
                >
            ...
            >
              {[
                { value: '80-120', label: t('hero.stats.pages') },
                { value: '249 zł', label: t('hero.stats.price') },
                { value: '24/7', label: t('hero.stats.available') },
              ].map((stat, i) => (
                <div key={i} className="text-center">
                  <div
                    className={`text-3xl font-bold mb-1 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent`}
                  >
                    {stat.value}
                  </div>
                  <div
